(function ($) {
	...
	function tp_port_brands_slider() {
		var tp_brand_slide = new Swiper(".tp-port-brand-active", {
			loop: true,
			freemode: true,
			slidesPerView: 'auto',
			spaceBetween: 30,
	...
	function tp_about_brands_slider() {
		var tp_brand_slide = new Swiper(".tp-about-brand-active", {
			loop: true,
			freemode: true,
			slidesPerView: 'auto',
			spaceBetween: 30,
	...
	function tp_about_text_slider() {
		var tp_brand_slide = new Swiper(".tp-about-text-active", {
			loop: true,
			freemode: true,
			slidesPerView: 'auto',
			spaceBetween: 30,
	...
	////team-slider
	function tp_team_slider_active() {
	...
	////career-slider
	function tp_career_slider_active() {
	...
	//------brand-slider---------//
	function design_hero_slider_active() {
	...
	function studio_step_slider_active() {
		//------testimonial-slider------//
	...
	//------ Home-Slider js-------//
	function tp_home_slider_active() {
	...
	$(window).on("elementor/frontend/init", function () {
		...
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-career-carousel.default", tp_career_slider_active
		);
		elementorFrontend.hooks.addAction(
		...
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-testimonial-list.default", tp_testi_slider
		);
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-shop-hero.default", shop_banner_slider
		);
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-hero-slider-text.default", design_hero_slider_active
		);
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/step-item.default", studio_step_slider_active
		);
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-architecture-brand-slider.default", tp_ar_brand_slider
		);
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-hero-image-slider.default", tp_home_slider_active
		);
		elementorFrontend.hooks.addAction(
		...
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-portfolio-slider.default", tp_port_brands_slider
		);
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-shop-text-slider.default", tp_shop_text_slider
		);
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-about-me-hero.default", tp_about_brands_slider
		);
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-about-text-slider.default", tp_about_text_slider
		);
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/tp-team-list.default", tp_team_slider_active
		);
