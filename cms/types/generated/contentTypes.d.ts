...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contact_address: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'4517 Washington Ave. Manchester, \nKentucky 39495'>;
    contact_email: Schema.Attribute.Email &
      Schema.Attribute.DefaultTo<'agntixs@studio.com'>;
    contact_phone: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'+(302) 555-0107'>;
    contact_title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'CONTACT'>;
    copyright_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'VIZON.STUDIO'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    headline: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Helping start-ups scale & grow.'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    quick_links: Schema.Attribute.Component<'shared.link', true>;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global sites settings like Identity, SEO, etc.';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
  ...
  attributes: {
    ...
    siteTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Edandevil Portfolio'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomeClientHomeClient extends Struct.SingleTypeSchema {
  collectionName: 'home_clients';
  info: {
    description: 'Clients and partners logos';
    displayName: 'Home Client';
    pluralName: 'home-clients';
    singularName: 'home-client';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomeHeroHomeHero extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Content for the Home Page Hero Section';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    small_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'The Creative'>;
    subtitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'/ FROM LONDON'>;
    title_line_1: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'We are The Creative'>;
    title_line_2: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'design'>;
    title_line_3: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'studio'>;
    torus_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHomeLatestBlogHomeLatestBlog
  extends Struct.SingleTypeSchema {
  collectionName: 'home_latest_blogs';
  info: {
    description: '';
    displayName: 'Home Latest Blog';
    pluralName: 'home-latest-blogs';
    singularName: 'home-latest-blog';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-latest-blog.home-latest-blog'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiHomeMarqueeHomeMarquee extends Struct.SingleTypeSchema {
  collectionName: 'home_marquees';
  info: {
    description: '';
    displayName: 'Home Marquee';
    pluralName: 'home-marquees';
    singularName: 'home-marquee';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'shared.marquee-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-marquee.home-marquee'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    detailImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    ...
    > &
      Schema.Attribute.Private;
    process: Schema.Attribute.Component<'project.process', false>;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.String;
    services: Schema.Attribute.JSON;
    slug: Schema.Attribute.UID<'title'>;
    storeImages: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::home-client.home-client': ApiHomeClientHomeClient;
      ...
      'api::home-latest-blog.home-latest-blog': ApiHomeLatestBlogHomeLatestBlog;
      'api::home-marquee.home-marquee': ApiHomeMarqueeHomeMarquee;
